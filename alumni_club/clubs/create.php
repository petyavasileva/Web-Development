...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($name === "" || $description === "") {
        ...
        // Owner becomes a member too (nice UX)
        ...
        header("Location: /alumni_club/clubs/view.php?id=" . (int)$club_id);
        exit;
    }
}
...
<a class="btn btn--sm" href="/alumni_club/clubs/index.php">← Назад</a>
