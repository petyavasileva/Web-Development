...
<a class="btn btn--sm" href="<?= app_url('clubs/view.php?id=' . (int)$club_id) ?>">← Назад</a>
...
<form method="post" class="card" style="max-width:820px;">
  <div class="card__pad">
    ...
    <a class="btn" href="<?= app_url('clubs/view.php?id=' . (int)$club_id) ?>" style="margin-left:8px;">Отказ</a>
  </div>
</form>
