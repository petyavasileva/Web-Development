...
<div style="display:flex; justify-content:space-between; align-items:flex-end; gap:12px; flex-wrap:wrap;">
  ...
  <?php if ($uid): ?>
    <a class="btn btn--primary" href="/alumni_club/clubs/create.php">+ Създай клуб</a>
  <?php endif; ?>
</div>
...
<form method="get" class="card" style="margin-bottom:14px;">
  <div class="card__pad" style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
    ...
    <a class="btn" href="/alumni_club/clubs/index.php">Изчисти</a>
  </div>
</form>
    ...
    <article class="card card--hover">
      <div class="card__pad">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
          <a class="btn btn--sm" href="/alumni_club/clubs/view.php?id=<?= (int)$c["id"] ?>">Отвори</a>
