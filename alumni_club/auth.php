...
<head>
  ...
  <title><?= e($title) ?></title>
  <link rel="stylesheet" href="<?= app_url('assets/theme.css') ?>">
  <link rel="stylesheet" href="<?= app_url('assets/style.css') ?>">
</head>
<body<?= $body_class !== '' ? ' class="' . e($body_class) . '"' : '' ?>>
<header class="nav">
  <div class="container nav__inner">
    <a class="brand" href="<?= app_url('index.php') ?>" aria-label="Начало">
    ...
    <nav class="nav__links" aria-label="Основна навигация">
      <a class="nav__link" href="<?= app_url('clubs/index.php') ?>">Клубове</a>

      <a class="nav__link" href="<?= app_url('events/index.php') ?>">Събития</a>
      <a class="nav__link" href="<?= app_url('chat/index.php') ?>">Чат</a>

      <?php if ($is_logged): ?>
        <span class="nav__chip" title="Влязъл потребител"><?= e($user_name ?: 'Потребител') ?></span>
        <a class="btn btn--ghost" href="<?= app_url('logout.php') ?>">Изход</a>
      <?php else: ?>
        <a class="btn btn--primary" href="<?= app_url('login.php') ?>">Вход</a>
        <a class="btn btn--primary" href="<?= app_url('register.php') ?>">Регистрация</a>
      <?php endif; ?>
    </nav>
  </div>
</header>
